...
function validateForm() {
    ...
    const subjectInput = form['_subject'];
    ...
    console.log("Formulaire est valide: " + isValid);

    // Si le formulaire est valide, rediriger vers l'URL de confirmation
    if (isValid) {
        window.location.href = "https://carmenferlatte.github.io/TP3__FerlatteCarmen/confirmation.html";
    }
