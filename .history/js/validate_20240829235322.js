...
//     } else {
//         // Rediriger vers la page de confirmation après une soumission réussie
//         event.preventDefault(); // Empêche la soumission par défaut pour permettre la redirection
